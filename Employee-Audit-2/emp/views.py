...
from .models import Employee, Task, AuditLog, Department, Project, Skill, Office, ProjectAssignment, EmployeeSkill, EmployeeOfficeAssignment, Position, Project
...
def add_department(request):
    if request.method == "POST":
        ...
        # return redirect("confirm_department.html")
...
def delete_department(request, department_id):
    ...
    log_entry = AuditLog(
        ...
        model='Department',
        object_id=department.id,
        details=f'Department {department.name} deleted.'
    )
    log_entry.save()
    ...
    # Redirect to a page, in this case, "department_list"
...
def update_department(request, department_id):
    ...
    if request.method == "POST":
        # Update department attributes based on the form data
        ...
        log_entry = AuditLog(
            ...
            model='Department',
            object_id=department.id,
            details=f'Department {department.name} updated.'
        )
        log_entry.save()

        # Redirect to a page, for example, "confirm_department.html" or "department_list"
        # return redirect("confirm_department")
